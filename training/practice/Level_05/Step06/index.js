...
// 一番レベルが高いメンバーを抽出
let highLevelChara = {};
highLevelChara = bravePartyObj.reduce((member, nextMember) => {
    return member.level > nextMember.level ? member : nextMember;
});

console.log('このパーティーで一番高いレベルのメンバーは、' + highLevelChara.name + 'です。');